...
# Retrieve the PID for all these participants, to keep the track 
...
# Write this list into a table
write.table(l_pid, "./list_20487_PID_for_EHv2.5.5.tsv", quote = F, row.names = F, col.names = F)
