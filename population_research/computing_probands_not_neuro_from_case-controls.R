...
## ATXN1
# cc tables
l_yes_cc = read.csv("../carriers/cc_pileup_100Kg/list_yes_ATXN1.txt",
                    stringsAsFactors = F,
                    header = F)
l_yes_cc = l_yes_cc$V1
length(l_yes_cc)
...
# unrel tables
l_yes_unrel = read.csv("../carriers/pileup_100Kg/list_yes_ATXN1.txt",
                       stringsAsFactors = F,
                       header = F)
l_yes_unrel = l_yes_unrel$V1
length(l_yes_unrel)
...
## ATXN2
# cc tables
l_yes_cc = read.csv("../carriers/cc_pileup_100Kg/list_yes_ATXN2.txt",
                    stringsAsFactors = F,
                    header = F)
l_yes_cc = l_yes_cc$V1
length(l_yes_cc)
...
# unrel tables
l_yes_unrel = read.csv("../carriers/pileup_100Kg/list_to_compute_yes_or_no_ATXN2.txt",
                       stringsAsFactors = F,
                       header = F)
l_yes_unrel = l_yes_unrel$V1
length(l_yes_unrel)
...
## C9ORF72
# cc tables
l_yes_cc = read.csv("../carriers/cc_pileup_100Kg/list_yes_C9ORF72.txt",
                    stringsAsFactors = F,
                    header = F)
l_yes_cc = l_yes_cc$V1
length(l_yes_cc)
...
# unrel tables
l_yes_unrel = read.csv("../carriers/pileup_100Kg/list_to_compute_yes_or_no_C9ORF72.txt",
                       stringsAsFactors = F,
                       header = F)
l_yes_unrel = l_yes_unrel$V1
length(l_yes_unrel)
...
## TBP
# cc tables
l_yes_cc = read.csv("../carriers/cc_pileup_100Kg/list_yes_TBP.txt",
                    stringsAsFactors = F,
                    header = F)
l_yes_cc = l_yes_cc$V1
length(l_yes_cc)
...
# unrel tables
l_yes_unrel = read.csv("../carriers/pileup_100Kg/list_to_compute_yes_or_no_TBP.txt",
                       stringsAsFactors = F,
                       header = F)
l_yes_unrel = l_yes_unrel$V1
length(l_yes_unrel)
